...
public class SocketRawMainActivity extends Activity {
    private final String TAG = "DEBUG";
    private EditText textToSend;
    private TextView textResponse;
    private EditText textIP;
    private EditText textPort;
    private String IP = "web.unisa.it"; //NOTA: web, non www, www risolve comunque
    private String PORT = "80";
    private String GET_REQ = "GET /home HTTP/1.1\n"
            + "Host: web.unisa.it\n"    //NOTA: web, non www, qui è importante web altrimenti non trova la pagina
            + "\n";
