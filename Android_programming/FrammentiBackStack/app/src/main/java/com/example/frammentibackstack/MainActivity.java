package com.example.frammentibackstack;
...
public class MainActivity extends Activity implements Autori.AuthorSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (screenw_px < screenh_px) {
            ...
            FrameLayout fl = (FrameLayout) findViewById(R.id.author_fragment_container);
            fl.getLayoutParams().width = (int)(screenw_px*0.33);
        }
        log("MODE=" + MODE);
