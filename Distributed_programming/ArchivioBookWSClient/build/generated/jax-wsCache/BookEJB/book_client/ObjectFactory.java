 ...
 * generated in the book_client package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddBook_QNAME = new QName("http://book_server/", "addBook");
    private final static QName _AddBookResponse_QNAME = new QName("http://book_server/", "addBookResponse");
    private final static QName _Book_QNAME = new QName("http://book_server/", "book");
    private final static QName _FindAll_QNAME = new QName("http://book_server/", "findAll");
    private final static QName _FindAllResponse_QNAME = new QName("http://book_server/", "findAllResponse");
    private final static QName _FindById_QNAME = new QName("http://book_server/", "findById");
    private final static QName _FindByIdResponse_QNAME = new QName("http://book_server/", "findByIdResponse");
    private final static QName _RemoveBook_QNAME = new QName("http://book_server/", "removeBook");
    private final static QName _RemoveBookResponse_QNAME = new QName("http://book_server/", "removeBookResponse");
    private final static QName _UpdateBook_QNAME = new QName("http://book_server/", "updateBook");
    private final static QName _UpdateBookResponse_QNAME = new QName("http://book_server/", "updateBookResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: book_client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "addBook")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "addBookResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "book")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "findAll")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "findAllResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "findById")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "findByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "removeBook")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "removeBookResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "updateBook")
     ...
     */
    @XmlElementDecl(namespace = "http://book_server/", name = "updateBookResponse")
