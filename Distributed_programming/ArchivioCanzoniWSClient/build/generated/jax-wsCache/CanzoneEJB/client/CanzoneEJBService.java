 ...
 * 
 */
@WebServiceClient(name = "CanzoneEJBService", targetNamespace = "http://bussiness.server/", wsdlLocation = "http://localhost:8080/CanzoneEJBService/CanzoneEJB?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CANZONEEJBSERVICE_QNAME = new QName("http://bussiness.server/", "CanzoneEJBService");
    ...
    public CanzoneEJB getCanzoneEJBPort() {
        return super.getPort(new QName("http://bussiness.server/", "CanzoneEJBPort"), CanzoneEJB.class);
    }
    ...
    public CanzoneEJB getCanzoneEJBPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bussiness.server/", "CanzoneEJBPort"), CanzoneEJB.class, features);
    }
