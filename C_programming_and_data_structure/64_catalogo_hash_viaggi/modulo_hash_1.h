...
2) deleteHash( table={}, info ) -> flag
                                  ...
                                  post_condition: flag=1 se data_i=info di table={data_1, data_2,..., data_n} eliminato, altrimenti flag=0

3) searchHash( table={}, info ) -> data={}
                                  pre_condition: table != NULL, info != NULL
                                  post_condition:  mod_i=info di table={mod_1, mod_2,..., mod_n} riportato, altrimenti flag=0

4) insertHash( table={}, mod={} ) -> flag
                                  pre_condition: table != NULL, mod != NULL
                                  post_condition: flag=1 se mod viene aggiunto a table={mod_1, mod_2,..., mod_n}, altrimenti flag=0
...
6) hash( nome, size ) -> mod
                                  pre_condition:
                                  post_condition: mod=calcolo sul codice ASCII della chiave del dato
------------------------------------------------------------------------------*/
