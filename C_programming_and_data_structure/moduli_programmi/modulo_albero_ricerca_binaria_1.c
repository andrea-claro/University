...
1) r_print( tree ) ->
                                  ...
                                  post_condition: (elementi di tree stampati a video)

2) r_delete( tree, data ) -> flag
                                  pre_condition: (tree != NULL) && (data != NULL)
                                  post_condition: (flag = 1 se elemento eliminato) &&
                                                  (flag = 0 se elemento non eliminato)

3) deleteMax( tree ) -> data
                                  pre_condition: (tree != NULL)
                                  post_condition: (ritorno di data)

4) r_insert( tree, data ) -> flag
                                  pre_condition: (tree != NULL) && (data != NULL)
                                  post_condition: (flag = 1 se elemento aggiunto) &&
                                                  (flag = 0 se elemento non aggiunto)

5) makeLeaf( data ) -> tree
                                  pre_condition: (data != NULL)
                                  post_condition: (tree != NULL)

6) r_contains( tree, data ) -> flag
                                  pre_condition: (tree != NULL) && (data != NULL)
                                  post_condition: (flag = 1 se elemento contenuto) &&
                                                  (flag = 0 se elemento non contenuto)
...
9) rightBtree( leaf ) -> leaf'
                                  pre_condition: (leaf != NULL)
                                  post_condition: (leaf' è uguale a ciò che punta right_leaf)

10 leftBtree( leaf ) -> leaf'
                                  pre_condition: (leaf != NULL)
                                  post_condition: (leaf' è uguale a ciò che punta left_leaf)
...
12) r_searchMax( max, leaf ) -> max
                                  pre_condition: (leaf != NULL)
                                  post_condition: (max è uguale al valore di leaf' puntata
                                                  a destra da leaf)
------------------------------------------------------------------------------*/
