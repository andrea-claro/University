...
int main(){
	...
	array1 = scelta_input(  array1, &dimensione_array1  );
	array1 = selection_sort_array_interi(  array1, dimensione_array1  );
	array1 = inserimento_in_array_interi(  array1, &dimensione_array1  );
	array1 = eliminazione_in_array_interi(  array1, &dimensione_array1  );
	array1 = selection_sort_array_interi(  array1, dimensione_array1  );
	minimo_array_binario_interi(  array1, dimensione_array1  );
	sum = somma_totale_array_interi(  array1, dimensione_array1  );
	printf(  "\nSecondo vettore:\n"  );
	array2 = scelta_input(  array2, &dimensione_array2  );
	array_somma = vet_somma_array_interi(  array1, array2, dimensione_array1, dimensione_array2  );
	sum = sommatoria_vettori_interi(  array1, array2, dimensione_array1, dimensione_array2  );
...
int *scelta_input(  int *vettore, int *dim  ){
