...
18) bubbleSortList( top={} ) ->
                                  pre_condition: top={data_1, data_2,..., data_n} != NULL
                                  post_condition: ogni data_i appartenente a top viene ordinato
